...
;(function (root) {
    ...
    Lexer.prototype.token = function (src, top) {
        ...
        while (src) {
            ...
            if (cap = this.rules.codeBlock.exec(src)) {
                ...
                item = {
                    type: 'codeBlock',
                    body: cap[2] /*PR.prettyPrintOne(cap[2], 'java', false)*/
                };
                this.tokens.push(item);
                continue;
            }
    ...
    Renderer.prototype.codeBlock = function (text) {
        ...
        return '<div class="marked">' +
            ...
            '    <img class="lazy" data-src="assets/img/clippy.svg" width="13" alt="Copy to clipboard">' +
            '</button>' +
            '</div>' +
        ...
        ;(function (root) {
            ...
            Renderer.prototype.codeBlock = function (text) {
                ...
                return '<div class="marked">' +
                    <!-- Trigger -->
                    '<button class="copy-button" title="copied!" type="button" data-clipboard-target="#marker-' + number + '" aria-label="Copy it!" data-balloon-pos="up">' +
                    '    <img class="lazy" src="assets/img/clippy.svg" width="13" alt="Copy to clipboard">' +
                    '</button>' +
                    '</div>' +
                    '<pre id="marker-' + number + '" class="display prettyprint language-java">\n' +
                    text.body +
...
// span level renderer
            ...
            Renderer.prototype.image = function (href, title, text) {
                ...
                let out = '<img class="lazy" data-src="' + href + '" alt="' + text + '"';
                if (title) {
                    out += ' title="' + title + '"';
                }
